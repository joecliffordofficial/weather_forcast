var citySearch;
var APIkey = '&appid=551b3960a22478295ce329c69f427943';
...
// Get info from API 
      ...
      $.ajax({
        ...
        if (uvi < 3) {
          $('#uvi-badge').css('background-color', '#45ef45');
        } else if (uvi < 6) {
          $('#uvi-badge').css('background-color', '#f5df46');
        } else if (uvi < 8) {
          $('#uvi-badge').css('background-color', '#f3960a');
        } else if (uvi < 11) {
          $('#uvi-badge').css('background-color', '#ed3c3c');
        } else {
          $('#uvi-badge').css('background-color', '#702789');
        }
      });
